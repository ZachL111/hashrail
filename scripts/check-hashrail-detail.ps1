...
$repo = "hashrail"
$language = "TypeScript"
$category = "Frontend and market data"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/hashrail-walkthrough.md")) {
