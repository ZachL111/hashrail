"""Regression checks for the hashrail casebook."""
...
from casebook.harness import assert_expected, hashrail_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(hashrail_summary(), assert_expected())
